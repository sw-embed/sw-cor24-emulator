//! Demo: Echo (Rust Logic + Interrupt Plumbing)
...
//! - Letters (a-z) echo as uppercase: 'a' → "A"
//! - '!' halts the program
//! - All other characters echo as-is: '3' → "3"
//!
//! Application logic (to_upper, handle_rx) is in pure Rust.
//! Only the interrupt plumbing uses asm!() passthrough:
